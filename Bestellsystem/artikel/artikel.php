...
$stmt = $pdo->prepare('SELECT * FROM artikel ORDER BY id');
$stmt->execute();
...
<body>
        ...
        <tbody>
            <?php foreach ($results as $result): ?>
                <tr>
                    ...
                    <td><?php echo htmlspecialchars($result['preis_netto']); ?></td>
                    <td><?php echo htmlspecialchars($result['ust_satz']); ?></td>
    ...
    <div class="add-btn-container">
        <a href="insert.php" class="btn">Neuen Artikel hinzufügen</a>
    </div>
</body>
</html>
